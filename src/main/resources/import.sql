...
VALUES ('100', true, DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), '01', '12345', '01',
       ...
       ('101', true, DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), '03', '98765', '01',
        '02', '03', '192.172.1.0', '', '', 101),
       ('102', true, DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), '04', '98765', '01',
        '02', '03', '192.172.1.0', '', '', 101),
       ('103', true, DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), '05', '98765', '01',
        '02', '03', '192.172.1.0', '', '', 101),
       ('104', true, DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), DATE_FORMAT(CURRENT_DATE, '%d.%m.%Y'), '06', '98765', '01',
        '02', '03', '192.172.1.0', '', '', 101)
;
